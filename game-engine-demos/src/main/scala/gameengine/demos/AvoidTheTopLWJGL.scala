...
object AvoidTheTopGameLWJGL extends gameengine.lwjgl.LWJGLGame with Game with EventInputStyle with ImperativeControlStyle {
		...
		gamestate match {
			case 0 =>
				withTranslation(10,20) {
					withScaling(15,15) {
						draw(new DrawableText("Best score: " + (maxScore/1000.0) + " seconds", new java.awt.Font("Monospaced", java.awt.Font.BOLD, 24), java.awt.Color.WHITE))
					}
				}
				withTranslation(10,80) {
					withScaling(20,20) {
						draw(new DrawableText("Click anywhere to play", new java.awt.Font("Monospaced", java.awt.Font.BOLD, 24), java.awt.Color.WHITE))
					}
				}
				withTranslation(10,50) {
					withScaling(15,15) {
						draw(new DrawableText("Last score: " + (lastScore/1000.0) + " seconds", new java.awt.Font("Monospaced", java.awt.Font.BOLD, 24), java.awt.Color.WHITE))
					}
				}
			case 1 =>
				for (p <- platforms) {
